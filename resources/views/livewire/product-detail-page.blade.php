<div class="w-full max-w-[85rem] py-10 px-4 pt-40 sm:px-6 lg:px-8 mx-auto font-tertiary">
    <section class="overflow-hidden bg-white py-11 font-poppins dark:bg-gray-800">
      <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
        <div class="flex flex-wrap -mx-4">
          <div class="w-full mb-8 md:w-1/2 md:mb-0 z-20" x-data="{ mainImage: '{{ url('storage', $product -> images) }}' }">
          ...
          <div class="w-full px-4 md:w-1/2 ">
            <div class="lg:pl-20">
              <div class="mb-8 ">
                <h2 class="max-w-xl mb-6 text-2xl font-bold dark:text-gray-400 md:text-4xl uppercase">
                  {{ $product -> name }}</h2>
                <p class="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400 ">
                  <span class="mr-2">PHP</span><span>{{ $product -> price }}</span>
                </p>
              ...
              <div class="flex flex-wrap items-center gap-4">
                <button wire:click.prevent='addToCart({{ $product->id }})' wire:click='addToCart({{ $product -> id }})' class="w-full p-4 bg-blue-500 rounded-md lg:w-2/5 dark:text-gray-200 text-gray-50 hover:bg-blue-600 dark:bg-blue-500 dark:hover:bg-blue-700">
